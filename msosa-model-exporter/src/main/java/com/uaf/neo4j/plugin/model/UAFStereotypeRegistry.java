...
public class UAFStereotypeRegistry {
    ...
    static {
        ...
        // Tier-1 #75 RC #6 reconciliation — added from iSCP diff. The MSOSA UAF 1.2
        ...
        // Tier-1 #75 RC #6 reconciliation — added from iSCP Capability Model diff.
        ...
        // Bare-noun catch-alls — see StereotypeInfo.isFallback. iSCP and similar
        ...
        // Tier-1 #75 RC #6 reconciliation — added from iSCP diff. Bare `Resource`
        // is the most aggressive collision source: in the iSCP profile it was
        // observed as the registered ancestor of operational-domain custom
        // stereotypes (e.g. `S&OP/E Analyst` qualifiedName ends in
        ...
        // Tier-1 #75 RC #6 reconciliation — added from iSCP diff.
        ...
        // Tier-1 #75 RC #6 reconciliation — added from iSCP diff. The MSOSA UAF 1.2
        // profile in iSCP uses SecurityEnclave/SecurityControl/etc. rather than the
        ...
        reg("Lane",                     "Lane",                    "BPMN");
        reg("Pool",                     "Pool",                    "BPMN");
        // Tier-1 #75 RC #6 reconciliation — BPMN extras found applied in iSCP.
