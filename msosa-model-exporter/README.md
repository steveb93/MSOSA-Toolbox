...
2. Select `target/msosa-model-exporter-1.6.0-Preview-plugin.zip`
...
Unzip `target/msosa-model-exporter-1.6.0-Preview-plugin.zip` directly into `<MSOSA_HOME>`. Restart MSOSA. The plugin appears under **Tools → UAF Neo4j Export**.
