...
2. Select `target/msosa-model-exporter-1.4.0-Preview-Preview-Preview-Preview-Preview-Preview-Preview-Preview-Preview-Preview-Preview-Preview-Preview-Preview-Preview-plugin.zip`
3. Restart MSOSA when prompted

**Option B — Manual:**

Unzip `target/msosa-model-exporter-1.4.0-Preview-Preview-Preview-Preview-Preview-Preview-Preview-Preview-Preview-Preview-Preview-Preview-Preview-Preview-Preview-plugin.zip` into `<MSOSA_HOME>/plugins/`:
