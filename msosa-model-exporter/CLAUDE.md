...
Outputs:
- `target/msosa-model-exporter-2.0.4-Preview.jar` — fat jar (Neo4j driver bundled + relocated)
- `target/msosa-model-exporter-2.0.4-Preview-plugin.zip` — drop into `<MSOSA_HOME>/plugins/`
