...
Outputs:
- `target/msosa-model-exporter-1.3.0-Preview-Preview-Preview-Preview.jar` — fat jar (Neo4j driver bundled + relocated)
- `target/msosa-model-exporter-1.3.0-Preview-Preview-Preview-Preview-plugin.zip` — drop into `<MSOSA_HOME>/plugins/`
...
<MSOSA_HOME>/plugins/msosa-model-exporter/
    msosa-model-exporter-1.3.0-Preview-Preview-Preview-Preview.jar
    plugin.xml
