...
Outputs:
- `target/msosa-model-exporter-1.5.0-Preview.jar` — fat jar (Neo4j driver bundled + relocated)
- `target/msosa-model-exporter-1.5.0-Preview-plugin.zip` — drop into `<MSOSA_HOME>/plugins/`
