...
Outputs:
- `target/msosa-model-exporter-2.0.2-Preview.jar` — fat jar (Neo4j driver bundled + relocated)
- `target/msosa-model-exporter-2.0.2-Preview-plugin.zip` — drop into `<MSOSA_HOME>/plugins/`
