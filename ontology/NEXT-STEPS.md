...
- [ ] **Further real-world profile registry tiers.** PR #82 reconciled Tier-1. Tiers 2–N (less common stereotypes flagged by `registry-diff.groovy`) remain as the profile expands.
