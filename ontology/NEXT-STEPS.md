...
- [ ] **SHACL + OWL coverage — remaining 3 domains.** Service, Personnel, Acquisition. Sketch: Service ⊑ ∃ providedBy . ResourcePerformer; Post ⊑ ∃ heldBy . Person; ProjectMilestone ⊑ ∃ partOf . Project. Wait for canonical class invariants to be agreed before shaping — too easy to invent constraints that don't reflect actual modelling discipline.
