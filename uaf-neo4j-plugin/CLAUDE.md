...
Outputs:
- `target/uaf-neo4j-plugin-1.0.1-Preview-Preview.jar` — fat jar (Neo4j driver bundled + relocated)
- `target/uaf-neo4j-plugin-1.0.1-Preview-Preview-plugin.zip` — drop into `<MSOSA_HOME>/plugins/`
...
<MSOSA_HOME>/plugins/uaf-neo4j-plugin/
    uaf-neo4j-plugin-1.0.1-Preview-Preview.jar
    plugin.xml
