...
2. Select `target/uaf-neo4j-plugin-1.0.1-Preview-Preview-plugin.zip`
3. Restart MSOSA when prompted

**Option B — Manual:**

Unzip `target/uaf-neo4j-plugin-1.0.1-Preview-Preview-plugin.zip` into `<MSOSA_HOME>/plugins/`:
