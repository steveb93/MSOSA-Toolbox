...
The zip (`target/msosa-model-exporter-2.1.0-Preview-plugin.zip`) extracts to a folder you drop into `<MSOSA_HOME>/plugins/`.
...
2. Unzip `target/msosa-model-exporter-2.1.0-Preview-plugin.zip` into `<MSOSA_HOME>/plugins/`
3. Restart MSOSA
